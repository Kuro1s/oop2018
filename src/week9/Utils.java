...
public class Utils {
    ...
    public static void main(String args[]){
        String readFormFile = Utils.readContentFormFile("src/week9/Text.txt");
        System.out.println(readFormFile);
        String newContent = "Hi World";
        Utils.writeContentToFile("src/week9/Text.txt",newContent);
        String newString = Utils.readContentFormFile("src/week9/Text.txt");
        System.out.println(newString);
        Utils.appendNewContentToFile("src/week9/Text.txt","Hello");
